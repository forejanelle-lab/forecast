...
-- Run after init migration (20250617120000_init) or via Supabase SQL Editor
...
CREATE TABLE IF NOT EXISTS "ActorHeadshot" (
    "id" TEXT NOT NULL,
...
CREATE INDEX IF NOT EXISTS "ActorHeadshot_actorId_idx" ON "ActorHeadshot"("actorId");

ALTER TABLE "ActorHeadshot" DROP CONSTRAINT IF EXISTS "ActorHeadshot_actorId_fkey";
...
CREATE INDEX IF NOT EXISTS "ActorMedia_actorId_idx" ON "ActorMedia"("actorId");

ALTER TABLE "ActorMedia" DROP CONSTRAINT IF EXISTS "ActorMedia_actorId_fkey";
ALTER TABLE "ActorMedia" ADD CONSTRAINT "ActorMedia_actorId_fkey"
  FOREIGN KEY ("actorId") REFERENCES "ActorProfile"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- Actor profile links (IMDb, website, demo reel links)
CREATE TABLE IF NOT EXISTS "ActorLink" (
    "id" TEXT NOT NULL,
    "actorId" TEXT NOT NULL,
    "label" TEXT NOT NULL,
    "url" TEXT NOT NULL,
...
CREATE INDEX IF NOT EXISTS "ActorLink_actorId_idx" ON "ActorLink"("actorId");

ALTER TABLE "ActorLink" DROP CONSTRAINT IF EXISTS "ActorLink_actorId_fkey";
ALTER TABLE "ActorLink" ADD CONSTRAINT "ActorLink_actorId_fkey"
  FOREIGN KEY ("actorId") REFERENCES "ActorProfile"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- Audition self-tape submission files
CREATE TABLE IF NOT EXISTS "AuditionSubmissionItem" (
    "id" TEXT NOT NULL,
...
CREATE INDEX IF NOT EXISTS "AuditionSubmissionItem_auditionId_idx" ON "AuditionSubmissionItem"("auditionId");

ALTER TABLE "AuditionSubmissionItem" DROP CONSTRAINT IF EXISTS "AuditionSubmissionItem_auditionId_fkey";
...
CREATE UNIQUE INDEX IF NOT EXISTS "Conversation_projectId_actorUserId_key"
  ON "Conversation"("projectId", "actorUserId");
CREATE INDEX IF NOT EXISTS "Conversation_actorUserId_idx" ON "Conversation"("actorUserId");
CREATE INDEX IF NOT EXISTS "Conversation_castingUserId_idx" ON "Conversation"("castingUserId");
...
ALTER TABLE "Conversation" DROP CONSTRAINT IF EXISTS "Conversation_actorUserId_fkey";
ALTER TABLE "Conversation" ADD CONSTRAINT "Conversation_actorUserId_fkey"
  FOREIGN KEY ("actorUserId") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

ALTER TABLE "Conversation" DROP CONSTRAINT IF EXISTS "Conversation_castingUserId_fkey";
...
ALTER TABLE "ConversationMessage" DROP CONSTRAINT IF EXISTS "ConversationMessage_senderId_fkey";
